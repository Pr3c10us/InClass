    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post(
          `${import.meta.env.VITE_BACKEND_URL}auth/student/register`,
          {
            name,
            matricNumber,
            email,
  ...
  return (
    <main className="flex flex-col items-center gap-12 p-6 pt-[10vh]">
      <section className="flex w-full flex-col items-center gap-4">
        ...
        <h1 className="text-xl font-medium">Create your student account</h1>
      </section>
      <form
      ...
      >
        ...
        />
        <Input
          inputFor={`matricNumber`}
          touched={formik.touched.matricNumber}
          error={formik.errors.matricNumber}
          handleChange={formik.handleChange}
          values={formik.values.matricNumber}
          handleBlur={formik.handleBlur}
          placeholder={"Matric Number - aaa/0000/000"}
        />
        <Input
          inputFor={`email`}
        ...
        <div className=" mt-6 flex flex-col  items-center md:col-span-2">
          ...
          <Link to={"/student/login"} className="mt-2 text-center text-sm">
